...
\author{David Kocman\\
\href{mailto:xkocma08@stud.fit.vutbr.cz}{xkocma08@stud.fit.vutbr.cz}}
\date{}
...
\begin{quotation}
{Čím více \emph{druhů}, \textbf{řezů}, {\tiny velikostí}, \textcolor{red}{barev} písma a~jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\Large \textbf{\fontfamily{pzc}\selectfont dokument}} vypadat.
{\hugeČ}{\LARGE t}{\Large e}{\large n}{\normalsize á}{\small ř} {\footnotesize t}{\scriptsize í}{\tiny m} bude vždy {\Huge\textbf{nadšen!}}}
\end{quotation}
...
Abychom \LaTeX u zabránili v~sázení \emph{osamocených předložek}, spojujeme je s~následujícím slovem nezlomitelnou mezerou.
