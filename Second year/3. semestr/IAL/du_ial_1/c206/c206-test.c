...
int main() {
	...
	checkInterconnectedness(TEMPLIST);
	ElemValue = 2;
	test_DLL_InsertFirst();
	checkInterconnectedness(TEMPLIST);
	test_DLL_GetFirst();
	...
	// MOJE TESY
    printf("\n[TEST01]\n"); 
    printf("Naplnění Listu pro testování DLPostDelete a DLPreDelete.\n");
	DLL_InsertLast(&TEMPLIST, 1);
	DLL_InsertLast(&TEMPLIST, 2);
	DLL_InsertLast(&TEMPLIST, 3);
	DLL_InsertLast(&TEMPLIST, 4);
	DLL_InsertLast(&TEMPLIST, 5);

    DLL_Last(&TEMPLIST);

	DLL_InsertLast(&TEMPLIST, 6);
	DLL_InsertLast(&TEMPLIST, 7);
	DLL_InsertLast(&TEMPLIST, 8);
	test_DLL_InsertLast(&TEMPLIST, ElemValue = 9);
	checkInterconnectedness(TEMPLIST);


    printf("\n[TEST02]\n"); 
    printf("Test všech možností DLPreDelete\n");
	test_DLL_DeleteBefore();
	checkInterconnectedness(TEMPLIST);
	test_DLL_DeleteBefore();
	checkInterconnectedness(TEMPLIST);
    ...
    printf("\n[TEST03]\n"); 
    printf("Test všech možností DLPostDelete\n");
	test_DLL_DeleteAfter();
	checkInterconnectedness(TEMPLIST);
	test_DLL_DeleteAfter();
	checkInterconnectedness(TEMPLIST);
	...
	test_DLL_InsertBefore(&TEMPLIST, ElemValue = 3);
	checkInterconnectedness(TEMPLIST);
    printf("InsertBefore %d\n", 4);
	test_DLL_InsertBefore(&TEMPLIST, ElemValue = 4);
	checkInterconnectedness(TEMPLIST);
    printf("InsertFirst %d\n", 2);
	test_DLL_InsertFirst(&TEMPLIST, ElemValue = 2);
	checkInterconnectedness(TEMPLIST);
    printf("InsertAfter %d\n", 7);
	test_DLL_InsertAfter(&TEMPLIST, ElemValue = 7);
	checkInterconnectedness(TEMPLIST);
    printf("InsertAfter %d\n", 6);
	test_DLL_InsertAfter(&TEMPLIST, ElemValue = 6);
	checkInterconnectedness(TEMPLIST);
    printf("InsertLast %d\n", 8);
	test_DLL_InsertLast(&TEMPLIST, ElemValue = 8);
	checkInterconnectedness(TEMPLIST);


    printf("\n[TEST05]\n"); 
    printf("Dispose List\n");
	test_DLL_Dispose(&TEMPLIST);
